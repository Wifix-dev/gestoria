            ...
            <div class="relative">
                ...
                <div class="flex flex-col space-y-3 lg:space-y-0 lg:grid lg:gap-4 lg:grid-cols-2">
                    ...
                    <div class="flex justify-center pt-3 lg:justify-end col-span-2">
                        <a class="group relative h-12 w-48 overflow-hidden rounded text-lg shadow flex justify-between bg-gray-900 text-white flex transition ease-in-out delay-150 hover:bg-gray-700 "
                            onclick="openModal()">
