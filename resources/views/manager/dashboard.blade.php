                    ...
                    <div class="flex items-center flex-wrap">
                        <ul class="flex items-center text-white">
                            <li class="inline-flex items-center">
                                <a href="#" class=" hover:text-blue-500 flex felx-col">
                                    <svg class="w-5 h-auto fill-current me-2 " xmlns="http://www.w3.org/2000/svg"
                                ...
                                <span class="mx-4 h-auto  font-medium">/</span>
                            </li>
                            <li class="inline-flex items-center">
